...
<footer class="container footer-distributed">
	...
	<div class="footer-left">
		...
		<p class="footer-company-name">Heppy Sentoso &copy; 2022 | Pemrograman Berbasis Web</a></p>
	</div>
	...
	<div class="footer-right">
		...
		if (isset($_POST['kirim'])) { //ketika tombol kirim ditekan maka akan menjalankan code bagian ini
			...
			$email = "peachsupply1@gmail.com"; //email penerima
			$to = $email;  //email penerima
			$subject = "Kritik Dan Saran dari $nama"; //subject pesan pada email

			//sender
			$sender = "peachsupply4@gmail.com"; //email pengirim
			$password = "Mafz0852"; //password email pengirim
